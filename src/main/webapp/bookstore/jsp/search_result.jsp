...
<div class="product">
        <div class="container">
			...
			%>
			<div class="box">         	 
				<img src="fileAction!download_pic.action?book_name=<%= book.getBook_name() %>" width="130" height="130"> 
			    <div style="margin-top: 10px;">			    	
			       <a class="title"><%= book.getBook_name()  %></a>
			    </div>
				<p ><em class="item_price">￥<%= book.getPrice() %></em></p>			
            ...
            <div class="modal-content modal-info">
                ...
                <div class="modal-body modal-spa">
                    <div class="col-md-3 span-2">
                        <div >
                            <img id="detail_pic" src="" height="150px" width="130px" style="margin:8px auto;">
                        </div>
                    </div>
                    <div class="col-md-9 span-5 ">
                        ...
                        <p class="title" id="detail_price"></p> 
                        <label>数量：</label>
...
$(".detail").click(function () {
	...
	$.ajax({
	    ...
	    success: function (data) {
		    ...
		    var download_url = "fileAction!download_pic.action?book_name=" + json["name"]
		    document.getElementById("detail_pic").setAttribute("src",download_url);
	    	//var modal = $("#myModal");
	    }
   	});
