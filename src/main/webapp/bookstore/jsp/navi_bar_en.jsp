...
<div >
      <nav class="navbar navbar-default" >
                ...
                <ul class="nav navbar-nav">
                    <li><a href="bookAction!getCategoryBook.action?category=noval">Noval</a></li>
                    <!--  
                    <li class="dropdown">
                    ...
                    -->
                    <li><a href="bookAction!getCategoryBook.action?category=education">Education</a></li>
                    <li><a href="bookAction!getCategoryBook.action?category=poetry">Poetry</a></li>
                    <li><a href="bookAction!getCategoryBook.action?category=prose">Prose</a></li>
                    <li><a href="bookAction!getCategoryBook.action?category=science">Science</a></li>
                    <li><a href="bookAction!getCategoryBook.action?category=biography">Biography</a></li>
                </ul>
...
<div style="position:fixed;width:300px;height:30px;top:155px;right:80px;" id="test"  >
	<form class="navbar-form navbar-right" role="form" action="bookAction!search" method="post" >
		<div class="form-group">                  
			<input name="name" class="form-control" id="search" placeholder="input something" onkeyup="showHint(this.value)" autocomplete="off">
